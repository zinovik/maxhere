...
There are a lot of really different <a href="https://boardgamegeek.com/browse/boardgamemechanic" target="_blank">mechanics</a> and <a href="https://boardgamegeek.com/browse/boardgamefamily" target="_blank">families</a> in board games.
...
1. **What can you do** - usually there is a lot of primitive actions in the game (like get the resource, exchange something, etc), these mechanics can define what set of actions can you perform at the moment
2. **Why do you do it** - basically, it's games final goals, you will get the victory points or something like that if you achieve it successfully

And many modern games have at least one mechanics from each category.

### Board game mechanics:<a name="list" />
...
## 1. What can you do<a name="what-can-you-do" /> [⬆️](#list)
...
## 2. Why do you do it<a name="why-do-you-do-it" /> [⬆️](#list)
