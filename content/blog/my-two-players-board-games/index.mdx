...
### The list of duel board games in my collection:<A id="list" />
...
### <Game gameName="Twilight Struggle" /> (<Designer name="ananda-gupta" />, <Designer name="jason-matthews" />)<A id="twilight-struggle" /> [⬆️](#list)
...
### <Game gameName="7 Wonders Duel" /> (<Designer name="antoine-bauza" />, <Designer name="bruno-cathala" />)<A id="7-wonders-duel" /> [⬆️](#list)
...
### <Game gameName="Patchwork" /> (<Designer name="uwe-rosenberg" />)<A id="patchwork" /> [⬆️](#list)
...
### <Game gameName="Star Realms" /> (<Designer name="robert-dougherty" />, <Designer name="darwin-kastle" />)<A id="star-realms" /> [⬆️](#list)
...
### <Game gameName="Jaipur" /> (<Designer name="sebastien-pauchon" />)<A id="jaipur" /> [⬆️](#list)
...
### <Game gameName="Hanamikoji" /> (<Designer name="kota-nakayama" />)<A id="hanamikoji" /> [⬆️](#list)
...
### <Game gameName="Battle Line" /> (<Designer name="reiner-knizia" />)<A id="battle-line" /> [⬆️](#list)
...
### <Game gameName="Hive" /> (<Designer name="john-yianni" />)<A id="hive" /> [⬆️](#list)
...
### <Game gameName="Lost Cities" /> (<Designer name="reiner-knizia" />)<A id="lost-cities" /> [⬆️](#list)
...
### <Game gameName="Arboretum" /> (<Designer name="dan-cassar" />)<A id="arboretum" /> [⬆️](#list)
...
. But I can't make a list with <Game
...
Almost all the games has the <a href="https://zinovik.github.io/digital-board-games" target="_blank">digital implementation</a>. Feel free to check ;)
