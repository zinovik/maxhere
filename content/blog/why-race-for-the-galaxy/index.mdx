...
featuredImage: race-for-the-galaxy.jpg
tags: ["board games"]
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/JcyyeAww2wc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### General info<a name="general-info" />[⬆️](#agenda)

![Race for the Galaxy](race-for-the-galaxy.jpg)

It's a kind of euro card game for 2-4 players with no much interaction. It was designed by <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom Lehmann</a> and published in 2007.

The main mechanics are: **Tableau Building**, **Hand Management** and **Cards Sifting**.

### Cards<a name="cards" />[⬆️](#agenda)
...
It's a card game, there are only cards and victory points as components. But these different ways of using cards makes it more similar to the usual euro games. But you can still play it fast!
...
### Cards Sifting<a name="cards-sifting" />[⬆️](#agenda)
...
<a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom Lehmann</a> compares 'card-sifting' to other variety approaches:<br /><br />
...
### The Goal<a name="the-goal" />[⬆️](#agenda)
...
### <Game gameName="Race for the Galaxy" isGameLinkOnly />, <Game gameName="Puerto Rico" isGameLinkOnly /> and <Game gameName="San Juan" isGameLinkOnly /><a name="race-for-the-galaxy-puerto-rico-and-san-juan" />[⬆️](#agenda)

<a href="https://boardgamegeek.com/boardgamedesigner/117/andreas-seyfarth" target="_blank">Andreas Seyfarth</a> is designer of a very popular euro game <Game gameName="Puerto Rico" isGameLinkOnly />.<br /><br />

<a href="https://boardgamegeek.com/boardgamedesigner/2820/stefan-bruck" target="_blank">Stefan Brück</a> - the publisher of the game, wanted to produce a card game to capitalize on <Game gameName="Puerto Rico" isGameLinkOnly /> success but <a href="https://boardgamegeek.com/boardgamedesigner/117/andreas-seyfarth" target="_blank">Andreas's Seyfarth</a> prototype wasn't working.<br /><br />

He contacted <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom Lehmann</a> and ask him to be a backup designer for <Game gameName="Puerto Rico" isGameLinkOnly /> card game. Then <a href="https://boardgamegeek.com/boardgamedesigner/2820/stefan-bruck" target="_blank">Stefan Brück</a> combined <a href="https://boardgamegeek.com/boardgamedesigner/117/andreas-seyfarth" target="_blank">Andreas's Seyfarth</a> and <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom's Lehmann</a> prototypes with his own ideas to form <Game gameName="San Juan" isGameLinkOnly />.

But <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom Lehmann</a> wanted to see the game he designed published. He continued work, added ideas from his unpublished collectible card game **Duel for the Stars**, some new ideas, and created <Game gameName="Race for the Galaxy" isGameLinkOnly />.
...
So, he worked on problems he found in <Game gameName="Puerto Rico" isGameLinkOnly />:
1. Clockwise playing
2. Features "constraining", interaction
3. Limit the next player options
4. Picking a role (action) "blocks" it for a round

<a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom</a> noticed that position has a big influence on the game. You can sit after the player who will not allow you to win. Or if you sit after the less experienced player you will have benefit. He calls it "left-right binding".

And he came to these solutions:

1. There are simultaneous actions in the <Game gameName="Race for the Galaxy" isGameLinkOnly /> game. It allows to eliminate "left-right binding", every player can pick any role.
2. He increased build tempo/round from 0-1 to 0-2 (develop and settle).
3. He updated consume bonus from +1 to *2 VPs.

### Simultaneous actions<a name="simultaneous-actions" />[⬆️](#agenda)
...
3. For the **Settle**, you play it early to get cards and in mid to build VP engines. That's why <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom</a> took the idea with military worlds from his unpublished game. You can have a lot of points with this worlds and you can build it without cards, so you will want to do it in the late game.
5. For the **Produce**, it has the opposite to "Settle" problem - it has Belling the Cat issue. Everyone wants someone else to call produce. To solve it "Produce" was moved to the very end of the round. If you call it - you like other players can have benefit of it in the next round. Also, there are windfall worlds here to solve it. You will have a good upon being settled, but in the produce phase only if YOU pick the "Produce".
4. For the **Consume**, it has two different bonuses: x2 VP that works in the late game and Trade that allows to sell the good only for the player who picks it. Why isn't it the separate phase? To prevent the "Rick gets richer problem" issue. Because otherwise the game will be about getting the big world down first.

One of the main criticism of the <Game gameName="Race for the Galaxy" isGameLinkOnly /> is that this is a multi-player solitaire. But if you want to win you have to track your opponents, what phase do they want to play, how fast is their tempo. This is the interaction here.

In addition, simultaneous play can speed up multi-player games. <Game gameName="Race for the Galaxy" isGameLinkOnly /> plays maybe 5 minutes longer if it's 4 players game in comparing with 2-players game.
...
As for types of the powers <a href="https://boardgamegeek.com/boardgamedesigner/150/thomas-lehmann" target="_blank">Tom</a> speaks about two types of games, with big combo and smaller, incremental powers. And he tried to create the game the second type game. That's why the game has a lot of powers and icons for it.
...
### More<a name="more" />[⬆️](#agenda)

#### Switching cost<a name="switching-cost" />
...
#### Player types<a name="player-types" />
...
### What's next?<a name="what-s-next" />[⬆️](#agenda)

#### 2nd Edition<a name="2nd-edition" />

![2nd Edition](second-edition.jpg)

#### Expansions<a name="expansions" />

1. <a href="https://boardgamegeek.com/boardgame/34499/race-galaxy-gathering-storm" target="_blank">Race for the Galaxy: The Gathering Storm (2008)</a>
...
2. <a href="https://boardgamegeek.com/boardgame/40210/race-galaxy-rebel-vs-imperium" target="_blank">Race for the Galaxy: Rebel vs Imperium (2009)</a>
...
3. <a href="https://boardgamegeek.com/boardgame/66121/race-galaxy-brink-war" target="_blank">Race for the Galaxy: The Brink of War (2010)</a>
...
4. <a href="https://boardgamegeek.com/boardgame/92932/race-galaxy-alien-artifacts" target="_blank">Race for the Galaxy: Alien Artifacts (2013)</a>
