...
<Game gameName="Twilight Struggle" isGameLinkOnly /> is the heaviest game in this list. The game box says it takes 3 - 4 hours to play it.
...
<Game gameName="7 Wonders Duel" isGameLinkOnly /> is a 2 players variant of the famous <Game gameName="7 Wonders" isGameLinkOnly /> game. The "base" game is only for 3-7 players (best: 4-5). But it's not the only difference between the games.
<br /><br />
...
<Game gameName="Patchwork" isGameLinkOnly /> is a game where interesting mechanics intertwined with a cozy setting. Both players have patchwork quilt and 🧵 place patches on it to fill it as much as possible.
<br /><br />
Who doesn't know about the Tetris game? <Game gameName="Patchwork" isGameLinkOnly /> is kind of Tetris, but you are not on a hurry here.
<br /><br />
...
I didn't like <Game gameName="Star Realms" isGameLinkOnly /> right away. We had already played <Game gameName="Dominion" isGameLinkOnly /> and I thought why we need one more deck-building if there is already a top deck-building game?

A few years later I decided to give it a second chance. First of all, it's cheap. And it's has a good rating. And we liked it. The game is similar to <Game gameName="Dominion" isGameLinkOnly /> but it's different - you feel really different when you play it. It's easy to start playing it but still interesting after time.

It's a fast-paced 🚀 spaceship combat game. The cards you can buy are not fixed like in <Game gameName="Dominion" isGameLinkOnly /> and the interaction is more direct here. Also, there are fractions in the game, it allows you to create different combos.
...
<Game gameName="Jaipur" isGameLinkOnly /> is a game about trades in the city of Jaipur, the capital of Rajasthan. It's a fast-paced, a blend of tactics, risk, and luck.
<br /><br />
...
<Game gameName="Hanamikoji" isGameLinkOnly /> is a little bit strange game. The main reason is the "I Cut, You Choose" mechanics.
<br /><br />
...
I didn't want to buy the <Game gameName="Battle Line" isGameLinkOnly /> game after I had read the game description. It's the ♠️ Poker plagiarism! But again, the cheap price and the good rating (and the cult designer name) did their job. And I wasn't wrong.
...
<Game gameName="Hive" isGameLinkOnly /> is an abstract game. There are no dices or decks of cards here - absolutely no random, like chess. The rules are simple: each player has a set of 🕷️ insects and each insect works it's own way. But there is a lot of things to think about here.
<br /><br />
...
<Game gameName="Lost Cities" isGameLinkOnly /> is the first game from this list I have played and the second game by <a href="https://boardgamegeek.com/boardgamedesigner/2/reiner-knizia" target="_blank">🇩🇪 → 🇬🇧 Reiner Knizia</a> in this list. A really elegant and simple game, but it doesn't get boring over time.
<br /><br />
...
<Game gameName="Arboretum" isGameLinkOnly /> is **not a two players board game**. But I can't make list with <Game gameName="Lost Cities" isGameLinkOnly /> but without <Game gameName="Arboretum" isGameLinkOnly /> (that's why it's a bonus for this page). These games are very similar to me 🤔. In both games, you can choose where to draw the card to control the game pace and the game end.
<br /><br />
But <Game gameName="Arboretum" isGameLinkOnly /> has some interesting features. You have to manage few things in the game: you build alleys (by placing the cards in front of you) to collect more points at the end of the game, but in the same time you leave the cards with the same trees in your hand because the points for each tree will collect only the player who has the biggest points for this kind of 🌳 tree in his hand.
<br /><br />
...
Also, if the game is not for only two players doesn't mean that it's not the best for two players. For example we often play <Game gameName="Race for the Galaxy" isGameLinkOnly /> or <Game gameName="Azul" isGameLinkOnly />. And I think these games are the most ⚖️ balanced for only 2 players.
