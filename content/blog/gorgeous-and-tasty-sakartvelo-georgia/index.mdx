...
Summer is a good time for a vacation. Sometimes it's not many options to go to. In summer 2021, 🇬🇪 **Georgia** was one of the not many options for me. Maybe, that's why it was a little bit underrated. But now I want to return there because there are too many interesting places to see on one ✈️ trip.

This page is bigger than it should be, but I can't remove more photos from it. Sorry for that.
...
🇬🇪 **Georgia** (local call it Sakartvelo) is a small country between 🇷🇺 **Russia** on the north, Black sea on the west and 🇹🇷 **Turkey**, 🇦🇲 **Armenia** and 🇦🇿 **Azerbaijan** on the south and south-east.
...
One more ❔ question. What is the symbol of Batumi that can be found on this building on the next photo?

<Image
  link="v1630161864/maxhere/gorgeous-and-tasty-sakartvelo-georgia/20210730_173559.jpg"
  alt="the building with the symbol of Batumi"
/>
...
Hight buildings have tuned mass damper to reduce mechanical vibrations. Here is the one in the alphabetic tower.
...
I filmed this video several minutes.
...
But in two words: Jason and the Argonauts from 🇬🇷 **Greece** were looking for Golden Fleece here. Medea lived here fell in love with Jason killed her own brother and helped Jason to find it and run from here with him. But Jason decided to marries another woman later Medea killed her and her own children from Jason and disappeared (❤️‍🔥 burn herself).
...
Dancing ⛲ fountains is a real miracle to unite people of all the cultures and ages. All the people here look happy to observe these dances.
...
<Image
  ...
  alt="Khashlama in Shumeruli Batumi"
/>
...
<Image
  ...
  alt="Adjaruli (Adjarian) Khachapuri in Shumeruli Batumi"
/>
...
Erbohacho is an unusual dish - it's fondue-like, melted 🧀 cheese with ghee.

<Image
  link="v1630161851/maxhere/gorgeous-and-tasty-sakartvelo-georgia/20210729_174917.jpg"
  alt="Erbohacho in Pirosmani restaurant in Batumi"
/>
...
<Image
  ...
  alt="Ostri in Retro restaurant in Batumi"
/>
...
Usually, it is served with sauce (for example, Ajika) and Shotis Puri bread.

<Image
  link="v1630161900/maxhere/gorgeous-and-tasty-sakartvelo-georgia/20210731_204022.jpg"
  alt="Ajika sauce and Shotis Puri bread in Kala in Tbilisi"
/>
...
They still use qvevri (like 8000 years ago) to make wine.

Qvevri are large earthenware vessels used for the fermentation, storage and ageing of traditional Georgian wine.
...
<Image
  ...
  alt="qvevri for the wine-making in Marani hotel cellar in Batumi"
/>
...
It was really nice trip, bit I haven't been to **Svaneti** yet. Hope to return there one day.
